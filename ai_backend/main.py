...
- Clearly distinguish factual statements (from the data) from your own recommendations.
- Use simple, plain language. Avoid judgmental or shaming language about spending habits.
