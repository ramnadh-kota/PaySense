          ...
          child: Column(
            ...
            children: [
              ...
              Row(
                ...
                children: const [
                  QuickActionButton(icon: Icons.wallet_rounded, label: 'Add Expense'),
                  QuickActionButton(icon: Icons.account_balance_wallet_rounded, label: 'Add Income'),
                  QuickActionButton(icon: Icons.swap_horiz_rounded, label: 'Transfer'),
